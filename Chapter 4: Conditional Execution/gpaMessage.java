...
(The idea here is that the expression 3.2 * 3 in Java does not exactly equal 9.6. 
You should leave in the computation of the credits variable and should still make your test examine that variable's value, 
rather than just directly testing the gpa variable itself. */
...
if (Math.abs(credits - 9.6) < epsilon) {
